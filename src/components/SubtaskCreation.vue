        ...
        <div>
            <b-card>
                   ...
                   a radio to choose whether a student can compare its solution to the teacher solution-->
                    ...
                    <div v-if="showfull">
                        ...
                        <b-form-input
                            ...
                            :placeholder="$t('subtaskCreation.answerOption')"
                        ></b-form-input>
                        ...
                        <div>
                            <p
                                ...
                                :key="index"
                                class="bg-secondary text-light p-1 m-1 w-50"
                            >
                                {{ answerOption.text }}
                                <b-button class="bg-light text-dark" @click="removeAnswerOption(answerOption.index)">
                                    x
                                </b-button>
                            </p>
                        </div>
               ...
               a radio to choose if the row oder of the student solution matters when it's compared
                ...
                <div>
                    <b-button class="bg-info" @click="saveSubtask">{{ $t('subtaskCreation.save') }}</b-button>
                    <b-button class="bg-danger" @click="deleteSubtask">{{ $t('subtaskCreation.delete') }}</b-button>
                </div>
            </b-card>
        </div>
    </div>
    ...
    public saveSubtask() {
        Vue.nextTick(() => {
            if (this.subtask.type === SubtaskTypes.MultipleChoice) {
                (this.subtask as MultipleChoiceTask).answerOptions = this.answerOptions.map(
                    (answerOption: any) => answerOption.text
                );
