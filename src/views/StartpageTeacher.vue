<template>
    <div>
        ...
        <div class="container">
            ...
            <b-button class="mt-2 mb-2 float-left" @click="uploadTrigger">{{ $t('teacher.uploadDb') }}</b-button>
            <b-alert v-if="dbErrorMsg !== ''" v-model="dbErrorMsg" variant="danger" dismissible>
                {{ dbErrorMsg }}
            </b-alert>
            <input
                id="fileUpload"
